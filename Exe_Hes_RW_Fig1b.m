clc;clear;close all;%RW 形态+SVDPE
if 1
    n = 1e4;%length
    m = 4;%dimension
    ...
    for i = 1:simutimes
        ...
        %X_mts = limitwalk(X_mts,0*ones(m,1),5*ones(m,1));
...
drawout = 1;
figure
bc1 = boxchart(pe_mts','BoxEdgeColor','cyan','BoxFaceColor','cyan');
bc1.MarkerColor = [0.1 1 1];
bc1.MarkerSize = 2;
...
ax.YTick = 5.5:0.1:7;
grid on
fig_description = '0_SVD_Entropy_for_Random_Walk';
